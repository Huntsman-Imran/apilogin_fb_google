...
public class AdminController extends MyBaseController {
    ...
    public String home(Model model) {
        model.addAttribute("total_active_volume", 0);
        model.addAttribute("total_active_act", 0);
        model.addAttribute("total_active_section", 0);
        model.addAttribute("total_visitor", 0);
        return "admin/home";
    }
