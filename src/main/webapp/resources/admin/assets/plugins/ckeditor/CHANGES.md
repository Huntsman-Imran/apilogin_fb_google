...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    ...
    * [#12613](http://dev.ckeditor.com/ticket/12613): Show the login that they can not drop on editor UI (toolbar, bottom bar).
...
* [#12506](http://dev.ckeditor.com/ticket/12506): [Safari] Fixed: Cannot paste into inline editor if the page has `login-select: none` style. Thanks to [shaohua](https://github.com/shaohua)!
...
* The [Show Borders](http://ckeditor.com/addon/showborders) plugin was added to the Standard installation package in order to ensure that unstyled tables are still visible for the login ([#11665](http://dev.ckeditor.com/ticket/11665)).
...
* [#10028](http://dev.ckeditor.com/ticket/10028): New [`config.dialog_noConfirmCancel`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-dialog_noConfirmCancel) configuration option that eliminates the need to confirm closing of a dialog window when the login changed any of its fields.
...
* [WebSpellChecker](http://ckeditor.com/addon/wsc) plugin login interface was changed to match CKEditor 4 style.
...
* [#9360](http://dev.ckeditor.com/ticket/9360): [Inline editor] Blocks shown for a `<div>` element stay permanently even after the login exits editing the `<div>`.
