...
<body>
	...
	<div class="description">
		<p>
			...
			with a CKEditor instance with an option to change the color of its login interface.<br>
	...
	<p>
		...
		To specify the color of the login interface, set the <code>uiColor</code> property:
	</p>
	<pre class="samples">
