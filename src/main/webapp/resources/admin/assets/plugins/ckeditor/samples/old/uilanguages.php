...
<body>
	...
	<div class="description">
		<p>
			...
			with a CKEditor instance with an option to change the language of its login interface.
		</p>
		<p>
			...
			a drop-down list that lets the login change the UI language.
		</p>
		<p>
			By default, CKEditor automatically localizes the editor to the language of the login.
			...
			default CKEditor language to be used when a localization suitable for login's settings is not available.
		</p>
		<p>
			To specify the login interface language that will be used no matter what language is
			specified in login's browser or operating system, set the <code>language</code> property:
		</p>
<pre class="samples">
